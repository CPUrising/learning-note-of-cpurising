...
//问题 1：
//
//给定一个整数数组 nums 和一个整数 k。判断是否存在一个长度恰好为 k 的连续子数组，其中至少包含两个相等的元素。如果存在这样的子数组，返回 true；否则，返回 false。
//
//示例 1：
//
//输入：nums = \[1, 2, 3, 2, 4, 5]，k = 3
//
//输出：true
//
//解释：子数组 \[2, 3, 2]（索引 1 - 3）包含重复元素 2
//
//示例 2：
//
